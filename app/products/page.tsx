...
const applications: Application[] = [
  ...
  { name: "Neura MGD", description: "Our Markdown to Google Docs free tool! Automatic grammar fix, write and concert in real time and download .docx file:", status: "Ready", url: "https://mgd.meetneura.ai" },
        ...
        {categories.map((category) => (
          <div key={category.title} className="mb-16">
            ...
            <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
              {applications
                .filter((app) => category.filter.includes(app.name))
                .map((app, idx) => (
                  <Card
